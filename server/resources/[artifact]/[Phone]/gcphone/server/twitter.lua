...
function sendDiscordTwitter(tweet)
    local discord_webhook = GetConvar('twitter_discord_webhook', 'https://discord.com/api/webhooks/987363740792016906/v_-AgEq8p8JQOZLTPAZpGd9t8Oy6VkQtXQjEBLjZbIzonNhqmIAabuHlwL3z9_drB6lS')
    if discord_webhook == 'https://discord.com/api/webhooks/987363740792016906/v_-AgEq8p8JQOZLTPAZpGd9t8Oy6VkQtXQjEBLjZbIzonNhqmIAabuHlwL3z9_drB6lS' then
        return
    end
    local headers = {
